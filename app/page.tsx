    ...
    <div className="relative w-full h-full overflow-hidden bg-background">
      ...
      {!isPathMode && (
        <div className="absolute top-6 left-6 z-10">
          {showWelcome ? (
            <div className="w-[380px] bg-background/80 backdrop-blur-xl border border-border/50 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
              <div className="p-5">
            ...
            <Button 
              ...
              className="bg-background/80 backdrop-blur-xl border-border/50 shadow-sm rounded-full gap-2 text-muted-foreground hover:text-foreground animate-in fade-in duration-200"
            >
